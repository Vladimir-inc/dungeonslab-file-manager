...
export function registerSettings() {
  ...
  game.settings.register(MODULE_ID, SETTINGS.DISABLE_CHAT_GREETING, {
    name: "FILE_MANAGER_DUNGEONS_LAB.Settings.DisableChatGreeting.Name",
    hint: "FILE_MANAGER_DUNGEONS_LAB.Settings.DisableChatGreeting.Hint",
    scope: "world",
    config: true,
    type: Boolean,
    default: false,
  ...
  game.settings.register(MODULE_ID, SETTINGS.WEBP_QUALITY, {
    name: "FILE_MANAGER_DUNGEONS_LAB.Settings.WebpQuality.Name",
    hint: "FILE_MANAGER_DUNGEONS_LAB.Settings.WebpQuality.Hint",
    scope: "client",
    config: true,
    type: Number,
