...
export const SETTINGS = {
  ...
  DISABLE_CHAT_GREETING: "disableChatGreeting",
};
...
// friendly names for the storage sources Foundry can hand us, Forge adds its own on top of data/public
export const SOURCE_LABELS = {
  data: "Data",
  public: "Public",
  forgevtt: "The Forge Assets",
  "forge-bazaar": "The Bazaar",
};
